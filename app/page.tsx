...
// Matches the envelope's own fade-out delay (see Envelope.tsx TIMING.envelopeFadeDelay),
// so the content begins revealing exactly as the envelope starts dissolving —
// one continuous motion rather than two separate steps.
const OPEN_SEQUENCE_MS = 1250;
